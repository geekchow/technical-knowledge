...
- [00 · 总览：LLM 全景指南](llm-fundamentals/00-overview.md)
- [01 · WHY：LLM 解决了什么问题](llm-fundamentals/01-why.md)
- [02 · WHAT：定义、边界与生态位置](llm-fundamentals/02-what.md)
- [03 · 概念地图：全部概念与关键角色](llm-fundamentals/03-concept-map.md)
- [04 · 运行示例：一个问题、两个模型](llm-fundamentals/04-running-example.md)
- [05-01 · 深潜：训练管线，数据如何变成权重](llm-fundamentals/05-01-training-pipeline.md)
- [05-01a · 深潜：后训练细拆 —— SFT、RLHF、DPO、RLVR](llm-fundamentals/05-01a-post-training.md)
- [05-02 · 深潜：推理引擎，权重如何被读取](llm-fundamentals/05-02-inference-engine.md)
- [05-03 · 深潜：参数规模，为什么 7B、70B、670B 如此重要](llm-fundamentals/05-03-param-scale.md)
- [05-04 · 深潜：开源 vs 闭源，同一份权重两种交付](llm-fundamentals/05-04-open-vs-closed.md)
- [06 · 完整重演：带着全部深度重跑运行示例](llm-fundamentals/06-walkthrough.md)
- [07 · 下一步：动手验证与延伸阅读](llm-fundamentals/07-next-steps.md)
